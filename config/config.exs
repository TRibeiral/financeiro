...
config :financeiro,
  ...
  stock_quote_provider: Financeiro.Investments.YahooQuoteProvider,
...
config :financeiro, FinanceiroWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FinanceiroWeb.ErrorHTML, json: FinanceiroWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Financeiro.PubSub,
  live_view: [signing_salt: "V95mDfPT"]
...
config :financeiro, Financeiro.Mailer, adapter: Swoosh.Adapters.Local
